...
import app.factory.SingleStockTabularUseCaseFactory;
...
public class SingleStockTabularViewTest {
    ...
    static SingleStockTabularView singleStockTabularView;
    ...
    static void setUp() {
        ...
        singleStockTabularView = SingleStockTabularUseCaseFactory.createTabular(viewManagerModel,
                menuViewModel, singleStockViewModels, apiDataAccess);

        // Create the UI
        JFrame jf = new JFrame();
        jf.setContentPane(singleStockTabularView);
        jf.pack();
        jf.setVisible(true);
    }

    // Checks that the tabular view is set up with buttons
    @Test
    public void testSetUp() {
        // Checks that the buttons aren't null
        assertNotNull(singleStockTabularView);
        assertNotNull(singleStockTabularView.viewName);
        assertNotNull(singleStockTabularView.currentPrice);
        assertNotNull(singleStockTabularView.detail);
        assertNotNull(singleStockTabularView.table);
        assertNotNull(singleStockTabularView.title);
        assertNotNull(singleStockTabularView.menu);
    }

    @Test
    public void testCancelButtonPerformed() {

        singleStockTabularView.menu.doClick(); // Click the Button
